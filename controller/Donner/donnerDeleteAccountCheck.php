...
require_once('../../Model/Donner/donnerModel.php');
    ...
    if(strlen($_POST['password'])>=8)
		...
		if($check === false)
		{
			echo ' Wrong password <a href="../../View/Donner/donnerDeleteAccount.php">Back</a>';
		}
      ...
      if ( $_SESSION['password'] == $_POST['password'] ) {
        ...
        echo "Incorrect current password".'<a href="../../View/Donner/donnerDeleteAccount.php"> try again</a>';
      }
